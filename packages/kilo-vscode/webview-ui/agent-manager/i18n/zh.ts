export const dict = {
  ...
  "agentManager.worktree.moveToSection": "移动到部分",
  "agentManager.worktree.newSection": "新部分",
  "agentManager.worktree.ungrouped": "未分组",
  "agentManager.section.rename": "重命名部分",
  "agentManager.section.setColor": "设置颜色",
  "agentManager.section.delete": "删除部分",
  "agentManager.section.defaultColor": "默认",
  "agentManager.section.defaultName": "新部分",
