...
export const dict = {
  ...
  "remote.toast.enabled": "IDE 재시작 전까지 Remote 활성화됨",
  "remote.toast.disabled": "IDE 재시작 전까지 Remote 비활성화됨",
  "remote.status.connected": "Remote 제어 연결됨",
  "remote.status.connecting": "Remote 제어 연결 중…",
