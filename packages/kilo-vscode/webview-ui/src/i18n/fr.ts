export const dict = {
  ...
  "remote.toast.enabled": "Remote activé jusqu'au redémarrage de l'IDE",
  "remote.toast.disabled": "Remote désactivé jusqu'au redémarrage de l'IDE",
  "remote.status.connected": "Contrôle Remote connecté",
  "remote.status.connecting": "Connexion du contrôle Remote…",
