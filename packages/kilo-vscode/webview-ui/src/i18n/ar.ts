export const dict = {
  ...
  "remote.toast.enabled": "تم تمكين Remote حتى إعادة تشغيل IDE",
  "remote.toast.disabled": "تم تعطيل Remote حتى إعادة تشغيل IDE",
  "remote.status.connected": "التحكم Remote متصل",
  "remote.status.connecting": "التحكم Remote يتصل…",
