...
export const dict = {
  ...
  "remote.toast.enabled": "Remote 已启用，直到 IDE 重启",
  "remote.toast.disabled": "Remote 已禁用，直到 IDE 重启",
  "remote.status.connected": "Remote 控制已连接",
  "remote.status.connecting": "Remote 控制连接中…",
