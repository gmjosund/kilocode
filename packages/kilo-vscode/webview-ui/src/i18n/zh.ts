...
export const dict = {
  ...
  "settings.agentBehaviour.editMode.promptPreview.title": "系统提示预览",
  "settings.agentBehaviour.editMode.promptPreview.empty": "此代理未配置自定义提示。",
  "settings.agentBehaviour.editMode.promptPreview.copy": "复制到剪贴板",
  "settings.agentBehaviour.editMode.promptCopy": "复制系统提示",
  "settings.agentBehaviour.editMode.promptCopied": "已复制！",
