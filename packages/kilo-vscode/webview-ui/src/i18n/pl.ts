export const dict = {
  ...
  "remote.toast.enabled": "Remote włączone do ponownego uruchomienia IDE",
  "remote.toast.disabled": "Remote wyłączone do ponownego uruchomienia IDE",
  "remote.status.connected": "Sterowanie Remote połączone",
  "remote.status.connecting": "Łączenie sterowania Remote…",
