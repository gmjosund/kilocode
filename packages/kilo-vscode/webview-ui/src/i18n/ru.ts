export const dict = {
  ...
  "remote.toast.enabled": "Remote включен до перезапуска IDE",
  "remote.toast.disabled": "Remote отключен до перезапуска IDE",
  "remote.status.connected": "Управление Remote подключено",
  "remote.status.connecting": "Управление Remote подключается…",
