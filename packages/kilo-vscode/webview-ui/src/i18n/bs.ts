export const dict = {
  ...
  "remote.toast.enabled": "Remote omogućen do ponovnog pokretanja IDE-a",
  "remote.toast.disabled": "Remote onemogućen do ponovnog pokretanja IDE-a",
  "remote.status.connected": "Remote kontrola povezana",
  "remote.status.connecting": "Remote kontrola se povezuje…",
