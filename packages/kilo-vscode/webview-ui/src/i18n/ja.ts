export const dict = {
  ...
  "remote.toast.enabled": "IDE 再起動まで Remote を有効化しました",
  "remote.toast.disabled": "IDE 再起動まで Remote を無効化しました",
  "remote.status.connected": "Remote コントロール接続済み",
  "remote.status.connecting": "Remote コントロール接続中…",
