export const dict = {
  ...
  "remote.toast.enabled": "Remote habilitado hasta el reinicio del IDE",
  "remote.toast.disabled": "Remote deshabilitado hasta el reinicio del IDE",
  "remote.status.connected": "Control Remote conectado",
  "remote.status.connecting": "Conectando control Remote…",
