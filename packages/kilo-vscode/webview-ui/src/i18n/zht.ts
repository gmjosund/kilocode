...
export const dict = {
  ...
  "settings.agentBehaviour.editMode.promptPreview.title": "系統提示預覽",
  "settings.agentBehaviour.editMode.promptPreview.empty": "此代理未設定自訂提示。",
  "settings.agentBehaviour.editMode.promptPreview.copy": "複製到剪貼簿",
  "settings.agentBehaviour.editMode.promptCopy": "複製系統提示",
  "settings.agentBehaviour.editMode.promptCopied": "已複製！",
