...
export const dict = {
  ...
  "remote.toast.enabled": "Remote 已啟用，直到 IDE 重啟",
  "remote.toast.disabled": "Remote 已停用，直到 IDE 重啟",
  "remote.status.connected": "Remote 控制已連接",
  "remote.status.connecting": "Remote 控制連線中…",
